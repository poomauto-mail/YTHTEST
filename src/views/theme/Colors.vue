<template>
  ...
  <div>
    ...
    <!-- <link rel="preload" type="application/l10n" href="../../../public/web/viewer.js">
    <link rel="preload" type="application/l10n" href="../../../public/build/pdf.js"> -->
    <!-- <script type="text/javascript" src="../../../public/web/viewer.js"/>
    <script type="text/javascript" src="../../../public/build/pdf.js"/> -->
...
export default {
  ...
  mounted() {
   ...
   postscribe('#pdfscript','<script async src="pdfjs-dist/require.js"><\/script>')
   postscribe('#pdfscript','<script async src="pdfjs-dist/web/pdf_viewer.js"><\/script>')
   postscribe('#pdfscript','<script async src="pdfjs-dist/build/pdf.js"><\/script>')

    // var pdfjsLib = window['pdfjs-dist/build/pdf.js'];
    // let requires = document.createElement('script')
    //     requires.setAttribute('type', 'text/javascript')
    //     requires.setAttribute('src', 'pdfjs-dist/require.js')
    //     document.head.appendChild(requires)

    //     let viewer = document.createElement('script')
    //     viewer.setAttribute('type', 'text/javascript')
    //     viewer.setAttribute('src', 'pdfjs-dist/web/pdf_viewer.js')
    //     document.head.appendChild(viewer)

    //     let pdf = document.createElement('script')
    //     pdf.setAttribute('type', 'text/javascript')
    //     // pdf.setAttribute('src', '../../../public/build/pdf.js')
    //     pdf.setAttribute('src', 'pdfjs-dist/build/pdf.js')
